...
public final class AcquiringDtos {
    ...
    public record CelcoinAcquiringListRequest(String accountId, String customerId, String status, Integer page, Integer size) {}

    public record CelcoinAcquiringCustomerListResponse(
            List<CelcoinAcquiringCustomerResponse> customers, Integer page, Integer size, Long total, Map<String, Object> raw) {}
    ...
    public record CelcoinAcquiringCardResponse(
            String cardId, String customerId, String brand, String lastFourDigits, String status, Map<String, Object> raw) {}

    public record CelcoinAcquiringCardListResponse(
            List<CelcoinAcquiringCardResponse> cards, Integer page, Integer size, Long total, Map<String, Object> raw) {}
    ...
    public record CelcoinAcquiringChargeResponse(
            String chargeId, String customerId, String transactionId, BigDecimal amount, String status, Map<String, Object> raw) {}

    public record CelcoinAcquiringChargeListResponse(
            List<CelcoinAcquiringChargeResponse> charges, Integer page, Integer size, Long total, Map<String, Object> raw) {}
    ...
    public record CelcoinAcquiringPlanResponse(String planId, String name, BigDecimal amount, String status, Map<String, Object> raw) {}

    public record CelcoinAcquiringPlanListResponse(
            List<CelcoinAcquiringPlanResponse> plans, Integer page, Integer size, Long total, Map<String, Object> raw) {}
    ...
    public record CelcoinAcquiringSubscriptionListResponse(
            List<CelcoinAcquiringSubscriptionResponse> subscriptions, Integer page, Integer size, Long total, Map<String, Object> raw) {}
    ...
    public record CelcoinAcquiringSubscriptionTransactionRequest(
            String transactionId, @NotBlank String subscriptionId, BigDecimal amount, LocalDate dueDate, Map<String, Object> metadata) {}

    public record CelcoinAcquiringChargebackListResponse(
            List<CelcoinAcquiringChargebackResponse> chargebacks, Integer page, Integer size, Long total, Map<String, Object> raw) {}
    ...
    public record CelcoinAcquiringWebhookResponse(String webhookId, String eventType, String url, String status, Map<String, Object> raw) {}
    ...
    public record CelcoinAcquiringCardTokenResponse(String tokenId, String brand, String lastFourDigits, Map<String, Object> raw) {}
    ...
    public record CelcoinAcquiringReceivablesStatementResponse(
            String accountId, List<Map<String, Object>> entries, Integer page, Integer size, Long total, Map<String, Object> raw) {}
}
