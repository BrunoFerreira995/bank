...
public final class CardDtos {
    ...
    public record CelcoinCardIssueRequest(
            ...
            String holderName,
            String type,
            CelcoinCardAddress deliveryAddress,
            Map<String, Object> metadata) {}
    ...
    public record CelcoinCardListRequest(
            String cardAccountId, String status, String type, Integer page, Integer size) {}

    public record CelcoinCardListResponse(
            List<CelcoinCardResponse> cards, Integer page, Integer size, Long total, Map<String, Object> raw) {}
    ...
    public record CelcoinCardWebhookResponse(
            String webhookId, String eventType, String url, String status, Map<String, Object> raw) {}

    public record CelcoinCardWebhookTemplateResponse(
            String eventType, Map<String, Object> payload, Map<String, Object> raw) {}
